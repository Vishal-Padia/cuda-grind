...
int main()
{
    ...
    std::vector<std::pair<
        ...
        gemm_fp16_kernel_launch_functions{
            ...
            {"2D block tiling & 2D Warp Tiling & 2D thread tiling Matrix Transpose with Vectorized Memory Access Implementation", launch_two_dim_tiling_two_dim_warp_tiling_two_dim_thread_matrix_transpose_vec_memory_access_kernel<__half>}
        };
